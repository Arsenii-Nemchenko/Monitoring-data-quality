...
class TestClass(TestCase):
    ...
    def test_duplicate_count_CSV_case1(self):
        #Path to Test_cases_file-> CSV_cases -> cars_37rows_3empty_4duplicate.csv
    ...
    def test_duplicate_count_CSV_case2(self):
        # Path to Test_cases_file-> CSV_cases -> house_price_545rows_12duplicate.csv
    ...
    def test_duplicate_count_Parquet_case1(self):
        # Path to Test_cases_file -> Parquet_cases -> cs_loadouts_12duplicate.csv
    ...
    def test_duplicate_count_Parquet_case2(self):
        # Path to Test_cases_file -> Parquet_cases -> markets_8duplicate.parquet
    ...
    def test_duplicate_Json_case1(self):
        # Path to Test_cases_file -> JSON_cases -> cs_weapons_12duplicate_19null.json
    ...
    def test_duplicate_Json_case2(self):
        # Path to Test_cases_file -> JSON_cases -> courses_13duplicate_1null.json
